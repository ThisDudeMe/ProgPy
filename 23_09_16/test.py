...
def StartProgram():
    ...
    def DecryptText():
        clear_screen()  # Clear the screen before displaying the error
    ...
    def EncryptText():
        ...
        while True:
            ...
            if choice == 1:
                clear_screen()  # Clear the screen before displaying the URL input
                print("Where is your text located?")
                ...
                clear_screen()  # Clear the screen before displaying file selection
                print("Where is your text located?")
                ...
                clear_screen()  # Clear the screen before displaying manual text input
                print("Where is your text located?")
                print(Fore.RED, "Press (1) if you have a URL", resetStyle)
                print(Fore.RED, "Press (2) if you have a file on your computer", resetStyle)
